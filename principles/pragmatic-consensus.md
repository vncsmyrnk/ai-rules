...
**Over-engineered (Avoid unless necessary):**
```java
// Too much ceremony for a simple configuration read
public interface ConfigReaderFactory {
    ConfigReader createReader();
}

public class DefaultConfigReaderFactory implements ConfigReaderFactory {
...
**Pragmatic (Preferred for simplicity):**
```java
// Direct, readable, and widely understood by any developer
public class Config {
    public static Map<String, String> load() {
        // Simple logic to parse config file
    }
}
```